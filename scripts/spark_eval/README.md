...
# Run on genome (a few hrs) using a 10 node GCS cluster
nohup ./run_gcs_cluster.sh 10 genome_md-bqsr-hc_gcs.sh &
...
nohup ./run_gcs_cluster.sh 10 copy_genome_to_hdfs_on_gcs.sh genome_md-bqsr-hc_hdfs.sh &
```
