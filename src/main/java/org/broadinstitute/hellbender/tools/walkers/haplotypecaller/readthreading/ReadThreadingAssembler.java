...
public final class ReadThreadingAssembler {
     ...
     * @param softClippingAligner
     * @param leadingIndelAligner
    ...
    public AssemblyResultSet runLocalAssembly(final AssemblyRegion assemblyRegion,
                                              ...
                                              final SmithWatermanAligner softClippingAligner,
                                              final SmithWatermanAligner leadingIndelAligner) {
        ...
        Utils.nonNull(softClippingAligner, "softClippingAligner cannot be null");
        Utils.nonNull(leadingIndelAligner, "leadingIndelAligner cannot be null");
        ...
        findBestPaths(nonRefGraphs, refHaplotype, refLoc, activeRegionExtendedLocation, assemblyResultByGraph, resultSet, softClippingAligner);
