...
public final class LegacyCopyNumberArgument {
    ...
    public static final String STANDARDIZED_COPY_RATIO_PROFILE_FILE_SHORT_NAME = "sCR";

    public static final String DENOISED_COPY_RATIO_PROFILE_FILE_FULL_NAME = "denoisedCopyRatioProfile";
    public static final String DENOISED_COPY_RATIO_PROFILE_FILE_SHORT_NAME = "dCR";
}